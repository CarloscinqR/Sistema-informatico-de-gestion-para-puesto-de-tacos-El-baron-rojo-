from tkinter import *
from Prodcutos.nuevo_producto import nuevo_producto_
from Prodcutos.modificar_producto import modificar_producto_
from Prodcutos.ver_prodcutos import ver_productos_
...
def menu_producto_(ventana_menu):
    ...
    nuevoProducto=Button(contenedor_botones, text="Nuevo producto", font=("Inter", 24), fg="#A6171C", bg="#F1C045", command=lambda: nuevo_producto_(menu_productos))
    nuevoProducto.pack(padx=20, pady=10, fill="x")
    
    verProducto=Button(contenedor_botones, text="Ver productos", font=("Inter", 24), fg="#A6171C", bg="#F1C045", command=lambda: ver_productos_(menu_productos))
    verProducto.pack(padx=20, pady=10, fill="x")

    modificarProducto=Button(contenedor_botones, text="Modificar producto", font=("Inter", 24), fg="#A6171C", bg="#F1C045", command=lambda: modificar_producto_(menu_productos))
