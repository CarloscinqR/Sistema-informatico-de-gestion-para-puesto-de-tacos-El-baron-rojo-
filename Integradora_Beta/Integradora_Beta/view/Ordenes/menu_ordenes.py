from tkinter import *
from view.Ordenes.nueva_orden import nuevaorden
from view.Ordenes.ver_ordenes import verordenes
...
class menuordenes():
    ...
    def menu_ordenes_(ventana_menu):
        ...
        nuevaOrden=Button(contenedor_botones, text="Nueva orden", font=("Inter", 24), fg="#A6171C", bg="#F1C045", command=lambda: nuevaorden.nueva_orden_(menu_ordenes))
        nuevaOrden.pack(padx=20, pady=10, fill="x")
        
        verOrden=Button(contenedor_botones, text="Ver ordenes", font=("Inter", 24), fg="#A6171C", bg="#F1C045", command= lambda: verordenes.ver_ordenes_(menu_ordenes))
