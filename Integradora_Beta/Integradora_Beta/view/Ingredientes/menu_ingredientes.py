from tkinter import *
from view.Ingredientes.nuevo_ingrediente import nuevoingrediente
from view.Ingredientes.modificar_ingrediente import modificaringrediente
from view.Ingredientes.ver_ingredientes import veringredientes
...
class menuingrediente():
    ...
    def menu_ingrediente_(ventana_menu):
        ...
        nuevoIngrediente=Button(contenedor_botones, text="Nuevo ingrediente", font=("Inter", 24), fg="#A6171C", bg="#F1C045", command=lambda: nuevoingrediente.nuevo_ingrediente_(menu_ingredientes))
